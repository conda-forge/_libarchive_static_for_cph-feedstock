...
validate_recipe_outputs "_libarchive_static_for_cph-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="_libarchive_static_for_cph-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi