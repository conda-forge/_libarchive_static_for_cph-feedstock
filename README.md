About _libarchive_static_for_cph
================================
...
<table><tr>
    <td>Travis</td>
    <td>
      <a href="https://app.travis-ci.com/conda-forge/_libarchive_static_for_cph-feedstock">
        <img alt="linux" src="https://img.shields.io/travis/com/conda-forge/_libarchive_static_for_cph-feedstock/main.svg?label=Linux">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `_libarchive_static_for_cph` can be installed with `conda`:
...
```
mamba install _libarchive_static_for_cph
```

It is possible to list all of the versions of `_libarchive_static_for_cph` available on your platform with `conda`:
...
```
mamba search _libarchive_static_for_cph --channel conda-forge
```
...
mamba repoquery search _libarchive_static_for_cph --channel conda-forge

# List packages depending on `_libarchive_static_for_cph`:
mamba repoquery whoneeds _libarchive_static_for_cph --channel conda-forge

# List dependencies of `_libarchive_static_for_cph`:
mamba repoquery depends _libarchive_static_for_cph --channel conda-forge
```
